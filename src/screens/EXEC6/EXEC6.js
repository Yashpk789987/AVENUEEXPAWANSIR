...
import { cancel, doStep3 } from "../../redux/actions/user";
    ...
    <Container>
      ...
      <Content style={{ backgroundColor: "#000000" }} padder>
        <Grid style={{ alignItems: "center", paddingTop: hp(30) }}>
          ...
          <Row style={{ paddingTop: resizeHeight(10) }}>
            <Text style={styles.textverificationcodeText}>Rep Code</Text>
          </Row>
          ...
          <Row>
            <Text onPress={onCancel} style={styles.textcancelbuttonText}>
              Cancel
              {"\n"}
            </Text>
          </Row>
